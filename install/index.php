...
define('SOFT_NAME', '微信营销平台安装'.SOFT_VERSION);
...
'license'=>'<div class="license"><h1>系统安装协议</h1>
				...
				<p>感谢您选择本微信营销平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
			<strong>一、本授权协议适用且仅适用于更新，官方对本授权协议的最终解释权。</strong>
			    <p></p>
			<strong>二、协议许可的权利 </strong>
				<p>1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </p>
				<p>2、您可以在协议规定的约束和限制范围内修改本微信营销平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用本微信营销平台，还是部份栏目使用 微信营销平台，在你使用了本微信营销平台的网站主页上必须加上本微信营销平台  官方网址(<a href="xxxx" target="_blank">xxxx</a>)的链接。</p>
				<p>4、未经官方许可，禁止在本微信营销平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：V1.0</b></p>
                <p align=right>BY 微信营销平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微信营销平台安装程序',
